...
type MovieResolver interface {
	Combination(ctx context.Context, obj *model.Movie) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Movie.combination":
		if e.complexity.Movie.Combination == nil {
			break
		}

		return e.complexity.Movie.Combination(childComplexity), true
...
func (ec *executionContext) _Movie_combination(ctx context.Context, field graphql.CollectedField, obj *model.Movie) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Movie_combination(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Movie().Combination(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Movie_combination(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Movie",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) fieldContext_Mutation_CreateMovie(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "combination":
				return ec.fieldContext_Movie_combination(ctx, field)
			}
	...
	for i, field := range fields {
		...
		case "combination":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Movie_combination(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
